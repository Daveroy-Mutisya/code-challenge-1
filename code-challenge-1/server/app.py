...
def get_hero_details(id):
    ...
    if hero:
        # Ensure 'hero_powers' key is present even if empty
        hero_dict = hero.to_dict()
        hero_dict['hero_powers'] = []  # Ensure 'hero_powers' key is present
    ...
    if power:
        ...
        if new_description:
            if len(new_description) >= 20:  
                ...
                return jsonify({"errors": ["Description must be a string of 20 or more characters"]}), 400
        else:
